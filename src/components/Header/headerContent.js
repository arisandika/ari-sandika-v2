    ...
    <>
      <div className="header-content">
        <motion.div
          ...
          className={`side-pop-up ${
            contentVisible ? "pop-up-hide" : "pop-up-show"
          }`}
        >
          <span>
            I&apos;m Ari. Based <br /> in Tangerang.
          </span>
          <div className="globe-bg">
            <div className="globe-container" onClick={handleContentToggle}>
              <svg
                className={`globe rotating`}
